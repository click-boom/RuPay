...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new view.custom.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new view.custom.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new view.custom.datechooser.Button();
        cmdPrevious = new view.custom.datechooser.Button();
        slide = new view.custom.datechooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/custom/datechooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/custom/datechooser/previous.png"))); // NOI18N
    ...
    private view.custom.datechooser.Button cmdForward;
    private view.custom.datechooser.Button cmdMonth;
    private view.custom.datechooser.Button cmdPrevious;
    private view.custom.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private view.custom.datechooser.Slider slide;
